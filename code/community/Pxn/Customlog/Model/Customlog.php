...
class Pxn_Customlog_Model_Customlog extends Mage_Core_Model_Abstract 
{
    ...
    public static function getLevelName ($level)
    {
    	...
    	if ($level == self::ERROR) $name = Mage::helper('customlog')->__('ERROR');
    	else if ($level == self::WARN) $name = Mage::helper('customlog')->__('WARN');
    	else if ($level == self::INFO) $name = Mage::helper('customlog')->__('INFO');
    	else if ($level == self::DEBUG) $name = Mage::helper('customlog')->__('DEBUG');
